...
namespace CarConnect.Model
{
    internal class Admin
    {
        ...
        {
            return $"AdminID: {AdminID}, FirstName: {FirstName}, LastName: {LastName}, Email: {Email}, PhoneNumber: {PhoneNumber}, Username: {Username}, Password: {Password}, Role: {Role}, JoinDate: {JoinDate}";
        }
